...
Upload chrome-web-store-0.6.31.zip. Add store screenshots of the actual dashboard and running session only after browser verification. Store review may require changes; do not represent this as approved.

Version 0.6.31 repairs active-video like/follow controls and confirmation, opens search results before engagement, and stops on visible TikTok access denials or account checks. TikTok comments remain unavailable. Both archives are checked against source; signed-in live engagement remains unverified.
