...
Upload chrome-web-store-0.6.29.zip. Add store screenshots of the actual dashboard and running session only after browser verification. Store review may require changes; do not represent this as approved.

Version 0.6.29 hides and disables unfinished account creation and phone setup, removes their host permissions, and retains the simpler comments.
