...
Upload chrome-web-store-0.6.30.zip. Add store screenshots of the actual dashboard and running session only after browser verification. Store review may require changes; do not represent this as approved.

Version 0.6.30 keeps TikTok warm-ups running through normal search-route and video-URL rewrites while retaining the warm-up-only release.
