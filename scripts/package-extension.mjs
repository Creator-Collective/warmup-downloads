...
await copyFile(path.join(root,'select-ui.js'),path.join(extension,'select-ui.js'));
await copyFile(path.join(root,'signup-ui.js'),path.join(extension,'signup-ui.js'));
await copyFile(path.join(root,'phone-ui.js'),path.join(extension,'phone-ui.js'));
...
for (const name of ['platform-instagram.svg','platform-tiktok.svg']) await copyFile(path.join(root,name),path.join(extension,name));
