...
for (const file of ['comment-history.js','session-results.js','dashboard.js','select-ui.js','signup-ui.js','phone-ui.js','plan.js','dashboard.css','inter.woff2','cc-logo.webp','INTER-LICENSE.txt']) {
